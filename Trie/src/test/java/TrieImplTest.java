...
/**
 * Created by kravtsun on 27.02.17.
 */
public class TrieImplTest {

    static int MAX_STRING_SIZE = 100;
    static int TESTS_COUNT = 10000;

    static Random randomizer;
    static String random_symbols;
